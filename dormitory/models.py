...
class DormDetail(models.Model):
    ...
    water_unit = models.IntegerField(default=0,verbose_name="อัตราค่าน้ำประปา ")
    water_month = models.CharField(max_length=100,default="ต่อคน",verbose_name="อัตราค่าน้ำประปา คน/หน่วย")
